    ...
    return Scaffold(
      ...
      body: dbAsync.when(
        ...
        data: (db) => FutureBuilder(
          future: db.listEntities('attendance'),
          builder: (ctx, snap) {
            ...
            return RefreshIndicator(
              onRefresh: () async {
                await ref.read(syncEngineProvider)?.syncMailbox('attendance');
              },
              child: ListView.builder(
                ...
                itemBuilder: (ctx, i) {
                  ...
                  return ListTile(
                    title: Text(data['employeeCode'] as String? ?? items[i]['id'] as String),
                    subtitle: Text(data['date'] as String? ?? ''),
