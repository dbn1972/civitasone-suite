...
export default function InvestigationError({ error, reset }: Props) {
  return (
    <div className="wrap" role="alert" aria-live="assertive" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "60vh", gap: 24, textAlign: "center" }}>
      ...
      <div>
        <h1 style={{ fontSize: "1.5rem", fontWeight: 600, color: "var(--ink)", marginBottom: 8 }}>Failed to load investigations</h1>
      ...
      <div style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
        ...
        <Link href="/audit" className="btn ghost" style={{ minHeight: 44 }}>Back to Audit</Link>
      </div>
    </div>
  );
}
