...
export default async function AuditObservationDetailPage({ params }: { params: { id: string } }) {
  ...
  const statusVariant = obs.status === "open" ? "warn"
    : obs.status === "closed" ? "good"
    : obs.status === "replied" ? "info"
    : "mut";
    ...
    <div className="wrap">
      <PageHeader
        ...
        actions={
          <>
            ...
            <button className="btn primary">Record Reply</button>
          </>
        }
      />
      ...
      <div className="grid g-main" style={{ alignItems: "start" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
          <div className="card">
            ...
            <div className="fields">
              ...
              {obs.amount != null && <div className="fld"><div className="l">Money value</div><div className="v">₹{(obs.amount / 100).toLocaleString("en-IN")}</div></div>}
              <div className="fld"><div className="l">Risk</div><div className="v">{obs.severity}</div></div>
              <div className="fld"><div className="l">Raised</div><div className="v">{obs.raisedDate}</div></div>
              {obs.dueDate && <div className="fld"><div className="l">Reply due</div><div className="v">{obs.dueDate}</div></div>}
        ...
        <div className="card">
          ...
          <div className="pad">
            <ul className="tl">
              <li className="done"><div className="t">Raised</div><div className="d">{obs.raisedDate}</div></li>
