...
export const getCatalogueCategories = moduleLoader("/api/v1/catalogue/products/tree", "catalogue.categories");
export const getCatalogueRates = moduleLoader("/api/v1/catalogue/rates", "catalogue.rates");
export const getCatalogueBundles = moduleLoader("/api/v1/catalogue/bundles", "catalogue.bundles");
