...
export default function ContractDetailError({ error, reset }: Props) {
  return (
    <div
      className="wrap"
      role="alert"
    ...
    >
      ...
      <div>
        ...
        <p style={{ color: "var(--ink2)", maxWidth: 480, margin: "0 auto" }}>
          {error.message || "An unexpected error occurred while loading this contract."}
        </p>
      ...
      <div style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
        ...
        <Link href="/contracts/list" className="btn ghost" style={{ minHeight: 44 }}>
          Back to list
        </Link>
      </div>
    </div>
