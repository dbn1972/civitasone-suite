...
export default function ContractsListError({ error, reset }: Props) {
  return (
    <div
      className="wrap"
      role="alert"
    ...
    >
      ...
      <div>
        ...
        <p style={{ color: "var(--ink2)", maxWidth: 480, margin: "0 auto" }}>
          {error.message || "An unexpected error occurred while loading the contracts list."}
        </p>
      ...
      <div style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
        ...
        <Link href="/contracts" className="btn ghost" style={{ minHeight: 44 }}>
          Back to Contracts
        </Link>
      </div>
    </div>
