...
/**
 * Escalation-rule thresholds change how every case in the register gets escalated.
...
export default function EscalationRulesLayout({ children }: { children: ReactNode }) {
