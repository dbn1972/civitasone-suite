...
/**
 * Qualification frameworks change what every rep is required to capture before a lead can progress.
...
export default function QualificationFrameworksLayout({ children }: { children: ReactNode }) {
