...
interface EstabErrorProps {
  error: Error & { digest?: string };
  reset: () => void;
}

export default function EstabError({ error, reset }: EstabErrorProps) {
  return (
    <div className="wrap" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "60vh", gap: 24, textAlign: "center" }}>
      ...
      <div>
        ...
        <p style={{ color: "var(--ink2)", maxWidth: 480, margin: "0 auto" }}>
          {error.message || "An unexpected error occurred in the Establishment module."}
        </p>
      ...
      <div style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
        ...
        <Link href="/estab/list" className="btn ghost">
