...
/**
 * /finance/expenses called finance-service routes that 404 (there is no
 * `/api/v1/finance/expenses` GET on this page's old shape) and is superseded
