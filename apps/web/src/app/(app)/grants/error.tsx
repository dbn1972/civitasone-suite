...
interface GrantsErrorProps {
  error: Error & { digest?: string };
  reset: () => void;
}

export default function GrantsError({ error, reset }: GrantsErrorProps) {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-6 bg-slate-50 p-8 text-center">
      ...
      <div className="space-y-2">
        ...
        <p className="max-w-md text-slate-500">
          {error.message || "An unexpected error occurred in the Grants module."}
        </p>
