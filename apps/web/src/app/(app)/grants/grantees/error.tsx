...
export default function GranteesError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Grantees error:", error);
  }, [error]);
  ...
  return (
    <div role="alert" style={{ padding: "24px 0" }}>
      <EmptyState
        ...
        message={
          error.message ||
          "The Grantees page hit an unexpected error. You can retry, or return to the Grants dashboard."
        }
        action={
