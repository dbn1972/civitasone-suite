...
export default async function OvertimePage() {
  ...
  return (
    <main className="page-main wrap" aria-labelledby="page-heading">
      ...
      <StatGrid>
        <StatCard icon="⏱️" iconBg="var(--infobg, #e6f0ff)" label="Total Requests" value={requests.length} />
        <StatCard icon="⏳" iconBg="var(--warnbg, #fffbe6)" label="Pending Approval" value={pending} />
        <StatCard icon="✅" iconBg="var(--goodbg, #e6f7f0)" label="Approved" value={approved} />
        <StatCard icon="🕐" iconBg="var(--bg, #f5f5f5)" label="Total Hours" value={`${totalHrs.toFixed(1)} h`} />
      </StatGrid>
