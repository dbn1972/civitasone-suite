...
export default function GpfError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("GPF Statements error:", error);
  }, [error]);
  ...
  return (
    <div role="alert" style={{ padding: "24px 0" }}>
      <EmptyState
        ...
        message={
          error.message ||
          "GPF Statements could not be loaded. You can retry, or return to the payroll section."
        }
        action={
