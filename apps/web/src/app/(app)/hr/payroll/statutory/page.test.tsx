...
describe("StatutoryHubPage", () => {
  it("renders links to every statutory console", () => {
    ...
    expect(screen.getByRole("link", { name: /\bESI\b/ })).toHaveAttribute("href", "/hr/payroll/statutory/esi");
    ...
    expect(screen.getByRole("link", { name: /\bGPF\b/ })).toHaveAttribute("href", "/hr/payroll/gpf");
    expect(screen.getByRole("link", { name: /\bNPS\b/ })).toHaveAttribute("href", "/hr/payroll/nps");
  });
});
