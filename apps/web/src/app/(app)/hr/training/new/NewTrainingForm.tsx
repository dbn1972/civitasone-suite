    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label htmlFor={fromDateId} className="block text-sm font-medium text-slate-700 mb-1">
            From Date <span aria-hidden="true" className="text-red-500">*</span>
          </label>
          <input
            id={fromDateId}
            type="date"
        ...
        <div>
          <label htmlFor={toDateId} className="block text-sm font-medium text-slate-700 mb-1">
            To Date <span aria-hidden="true" className="text-red-500">*</span>
          </label>
          <input
            id={toDateId}
            type="date"
      ...
      <div>
        <label htmlFor={maxParticipantsId} className="block text-sm font-medium text-slate-700 mb-1">
          Max Participants <span aria-hidden="true" className="text-red-500">*</span>
        </label>
        <input
