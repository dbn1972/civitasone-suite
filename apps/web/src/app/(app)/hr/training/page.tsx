      ...
      {source === "error" ? (
        ...
        <>
          <StatGrid>
            ...
            <StatCard icon="📅" iconBg="var(--infobg, #e6f0ff)" label="Upcoming" value={upcoming} />
            <StatCard icon="▶️" iconBg="var(--goodbg, #e6f7f0)" label="Ongoing" value={ongoing} />
            <StatCard icon="✅" iconBg="var(--warnbg, #fffbe6)" label="Completed" value={completed} />
          </StatGrid>
