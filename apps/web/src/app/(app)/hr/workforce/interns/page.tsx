...
/**
 * /hr/workforce/interns is the orphaned duplicate of /hr/interns.
 *
 ...
 * any in-app control. /hr/interns is the canonical page: the HR hub
 * (apps/web/src/app/(app)/hr/page.tsx, "Workforce" category) links it
 * directly as `{ title: t("interns"), href: "/hr/interns" }`.
 * /hr/workforce/interns has zero inbound links anywhere in the repo
 ...
 */
export default function WorkforceInternsPageRedirect() {
  redirect("/hr/interns");
}
