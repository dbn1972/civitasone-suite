...
const COLUMNS: { key: keyof OTRequest & string; label: string; cellType?: "status"; align?: "left" | "right" }[] = [
  ...
  { key: "hoursRequested", label: "Hours", align: "right" },
...
export default async function OvertimePage() {
  ...
  return (
    <main className="page-main wrap" aria-labelledby="page-heading">
      ...
      <StatGrid>
        <StatCard icon="⏱️" iconBg="#e6f0ff" label="Total Claims" value={requests.length} />
      ...
      <Card title="Overtime Claims">
        {requests.length === 0 ? (
          <EmptyState
            ...
            message="Overtime claims submitted by employees appear here for duty officer approval."
            action={<Link href="/hr/workforce/overtime/new" className="btn primary">+ New Request</Link>}
          />
        ) : (
          <DataTable<OTRequest>
            columns={COLUMNS}
            ...
            emptyMessage="Adjust your filter to find the overtime request."
          />
        )}
      </Card>
    </main>
