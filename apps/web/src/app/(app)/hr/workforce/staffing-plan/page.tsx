...
/**
 * /hr/workforce/staffing-plan is the orphaned duplicate of /hr/staffing-plan.
 *
 ...
 * any in-app control. /hr/staffing-plan is the canonical page: the HR hub
 * (apps/web/src/app/(app)/hr/page.tsx, "Workforce" category) links it
 * directly as `{ title: t("staffingPlan"), href: "/hr/staffing-plan" }`.
 * /hr/workforce/staffing-plan has zero inbound links anywhere in the repo
 ...
 */
export default function WorkforceStaffingPlanPageRedirect() {
  redirect("/hr/staffing-plan");
}
