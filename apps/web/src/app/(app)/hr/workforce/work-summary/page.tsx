...
export default async function WorkSummaryPage() {
  ...
  return (
    <main className="page-main wrap" aria-labelledby="page-heading">
      ...
      <StatGrid>
        <StatCard icon="📝" iconBg="var(--infobg, #e6f0ff)" label={t('statTotalRecords')} value={errored ? null : items.length} />
        ...
        <StatCard icon="⏳" iconBg="var(--warnbg, #fffbe6)" label={t('statPendingReview')} value={errored ? null : pending} />
      </StatGrid>
