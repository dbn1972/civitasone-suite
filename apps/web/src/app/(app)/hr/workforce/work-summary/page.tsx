...
/**
 * /hr/workforce/work-summary is the orphaned duplicate of /hr/work-summary.
 *
 ...
 * any in-app control. /hr/work-summary is the canonical page: the HR hub
 * (apps/web/src/app/(app)/hr/page.tsx, "Performance" category) links it
 * directly as `{ title: t("workSummaries"), href: "/hr/work-summary" }`.
 * /hr/workforce/work-summary has zero inbound links anywhere in the repo
 ...
 */
export default function WorkforceWorkSummaryPageRedirect() {
  redirect("/hr/work-summary");
}
