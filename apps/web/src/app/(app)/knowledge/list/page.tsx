    ...
    <main className="min-h-screen bg-slate-50 p-6 md:p-8">
      <section className="mx-auto max-w-7xl space-y-5">
        ...
        <header className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-3xl font-semibold text-slate-900">Knowledge — Documents</h1>
            <p className="mt-1 text-sm text-slate-600">All documents in the knowledge base.</p>
          </div>
        ...
        <section className="overflow-x-auto rounded-xl border border-slate-200 bg-white shadow-sm">
          <table aria-label="Knowledge documents" className="min-w-full text-left text-sm">
