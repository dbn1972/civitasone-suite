...
export const getLoyaltyPrograms = moduleLoader("/api/v1/loyalty/programs", "loyalty.programs");
export const getLoyaltyMembers = moduleLoader("/api/v1/loyalty/enrolments", "loyalty.members");
export const getLoyaltyAccruals = moduleLoader("/api/v1/loyalty/enrolments", "loyalty.accruals");
export const getLoyaltyRedemptions = moduleLoader("/api/v1/loyalty/redemptions", "loyalty.redemptions");
export const getLoyaltyTiers = moduleLoader("/api/v1/loyalty/programs", "loyalty.tiers");
