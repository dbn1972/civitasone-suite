  ...
  return (
    <div style={{ padding: "24px 0" }}>
      <EmptyState
        ...
        message="The Notifications module hit an unexpected error. You can retry, or head back to the dashboard."
        action={
          <div style={{ display: "flex", gap: 8, justifyContent: "center" }}>
            <button type="button" className="btn primary" onClick={reset}>Try again</button>
            <a className="btn ghost" href="/notifications">Go to Notifications</a>
          </div>
        }
      />
    </div>
