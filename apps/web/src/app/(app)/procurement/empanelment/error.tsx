...
export default function EmpanelmentError({ error, reset }: Props) {
  return (
    <div className="wrap" role="alert" aria-live="assertive" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "60vh", gap: 24, textAlign: "center" }}>
      ...
      <div>
        <h1 style={{ fontSize: "1.5rem", fontWeight: 600, color: "var(--ink)", marginBottom: 8 }}>Failed to load empanelment data</h1>
