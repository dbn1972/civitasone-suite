...
export const getRecNba = moduleLoader("/api/v1/recommendations/predictive", "recommendations.nba");
export const getRecMatrix = moduleLoader("/api/v1/recommendations/matrix", "recommendations.matrix");
export const getRecHealth = moduleLoader("/api/v1/recommendations/health/at-risk", "recommendations.health");
export const getRecFeedback = moduleLoader("/api/v1/recommendations/feedback", "recommendations.feedback");
