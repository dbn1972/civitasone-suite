    ...
    <main className="page-main wrap" aria-labelledby="page-heading">
      ...
      <Card title="Recovery register" padding>
        <p style={{ margin: 0, fontSize: 13.5, color: "var(--ink2)" }}>
          revenue-service does not yet expose a list endpoint for recovery referrals (only{" "}
          <code>POST /v1/revenue/recovery-referrals</code> exists — see{" "}
          <strong>## BACKEND FOLLOW-UPS</strong> in this PR). A referral takes effect immediately (status{" "}
