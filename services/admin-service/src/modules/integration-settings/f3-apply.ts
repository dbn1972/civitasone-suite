/** Auto-generated F3 apply (integration-settings). */
...
export async function apply_integration_settings_0(ctx: any, req: { body: unknown; params: unknown; query: unknown }): Promise<void> {
  // put:"/v1/admin/integrations/:provider/:env"
...
export async function apply_integration_settings_1(ctx: any, req: { body: unknown; params: unknown; query: unknown }): Promise<void> {
  // post:"/v1/admin/integrations/:provider/:env/approve"
    const { provider, env } = parseTarget(req.params);
...
export async function apply_integration_settings_2(ctx: any, req: { body: unknown; params: unknown; query: unknown }): Promise<void> {
  // post:"/v1/admin/integrations/:provider/:env/reject"
    const { provider, env } = parseTarget(req.params);
...
export async function apply_integration_settings_3(ctx: any, req: { body: unknown; params: unknown; query: unknown }): Promise<void> {
  // post:"/v1/admin/integrations/:provider/:env/test"
    const { provider, env } = parseTarget(req.params);
...
export async function apply_integration_settings_4(ctx: any, req: { body: unknown; params: unknown; query: unknown }): Promise<void> {
  // delete:"/v1/admin/integrations/:provider/:env"
    const { provider, env } = parseTarget(req.params);
