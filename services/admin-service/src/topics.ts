...
export const COMMANDS = {
  ...
  // F3 leftover — remaining admin sync route writes
  apiKeyCreate: "admin.api_key.create",
  apiKeyRotate: "admin.api_key.rotate",
  apiKeyRevoke: "admin.api_key.revoke",
  changeRequestCreate: "admin.change.request.create",
  changeRequestUpdate: "admin.change.request.update",
  changeRequestSubmit: "admin.change.request.submit",
  changeRequestApprove: "admin.change.request.approve",
  changeRequestReject: "admin.change.request.reject",
  changeRequestSchedule: "admin.change.request.schedule",
  changeRequestComplete: "admin.change.request.complete",
  changeRequestRollback: "admin.change.request.rollback",
  changeFreezeCreate: "admin.change.freeze.create",
  sandboxCreate: "admin.sandbox.create",
  sandboxMaskingUpsert: "admin.sandbox.masking.upsert",
  sandboxRefreshCreate: "admin.sandbox.refresh.create",
  sandboxRefreshApprove: "admin.sandbox.refresh.approve",
  sandboxRefreshCancel: "admin.sandbox.refresh.cancel",
  centralConfigChangeCreate: "admin.central_config.change.create",
  centralConfigChangeApprove: "admin.central_config.change.approve",
  centralConfigChangeReject: "admin.central_config.change.reject",
  artefactCreate: "admin.config.artefact.create",
  artefactPromotionCreate: "admin.config.artefact.promotion.create",
  artefactPromote: "admin.config.artefact.promote",
  artefactEnvBind: "admin.config.artefact.env_bind",
  artefactRollback: "admin.config.artefact.rollback",
  mobileTelemetryRecord: "admin.health.mobile_telemetry.record",
  deptTemplateCreate: "admin.dept_template.create",
  deptTemplateInstantiate: "admin.dept_template.instantiate",
  deptTemplateUpdate: "admin.dept_template.update",
  integrationChangeCreate: "admin.integration_settings.change.create",
  integrationChangeApprove: "admin.integration_settings.change.approve",
  integrationChangeReject: "admin.integration_settings.change.reject",
  integrationSettingUpdate: "admin.integration_settings.setting.update",
  docTypeCreate: "admin.uploads.doc_type.create",
  docTypeUpdate: "admin.uploads.doc_type.update",
  docRequirementUpsert: "admin.uploads.doc_requirement.upsert",
  documentCreate: "admin.uploads.document.create",
  documentTransition: "admin.uploads.document.transition",
  dataCorrectionCreate: "admin.support.data_correction.create",
