...
describe("VAPT + SOC2", () => {
  ...
  it("GET vapt/reports → 200", async () => { expect(await hit("GET", "/v1/admin/security/vapt/reports", admin)).toBe(200); });
  ...
  it("GET posture → 200", async () => { expect(await hit("GET", "/v1/admin/security/posture", admin)).toBe(200); });
