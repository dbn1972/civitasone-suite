/**
 * Shared test support for animal-service's DB-backed integration suite.
 * Mirrors services/swm-service/tests/support.ts and
 * services/sewerage-service/tests/*-integration.test.ts.
 *
...
export function hdr(
  sub = ACTOR_A,
  tid = TENANT_A,
  roles: string[] = ["animal_admin", "super_admin"],
