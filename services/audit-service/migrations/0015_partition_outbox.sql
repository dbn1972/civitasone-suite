-- 0015_partition_outbox.sql
-- Purpose: Convert _outbox.messages to monthly declarative partitioning on created_at.
--          The audit-service outbox is high-volume because every mutation across all
--          33 services emits an audit event that passes through this outbox.
...
-- Step 7: Helper function to auto-create partitions 3 months ahead
...
-- Step 8: Drop legacy table after successful migration (guarded)
