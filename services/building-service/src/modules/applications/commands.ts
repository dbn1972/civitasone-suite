...
export interface CreateBuildingApplicationInput {
  siteAddress: { line1: string; line2?: string | undefined; city: string; pin: string; ward?: string | undefined; zone?: string | undefined; surveyNumber?: string | undefined };
  plotArea?: number | undefined;
  builtUpArea?: number | undefined;
  proposedFloors?: number | undefined;
  fsiRequested?: number | undefined;
  architectName?: string | undefined;
  architectLicenceNo?: string | undefined;
  structuralEngineer?: string | undefined;
  documents?: Array<{ docType: string; fileId: string; uploadedAt: string }> | undefined;
  drawings?: Array<{ drawingType: string; fileId: string; versionNumber: number; uploadedAt: string }> | undefined;
}

export async function createApplication(ctx: RequestContext, body: CreateBuildingApplicationInput): Promise<Accepted> {
  const id = randomUUID();
