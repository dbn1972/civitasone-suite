/**
 * Citizen search indexing — wires @civitasone/search indexing via the outbox.
 *
...
/** Index or update a citizen entity in the global search. */
...
/** Remove a citizen entity from the global search (on soft-delete). */
