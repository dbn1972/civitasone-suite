/**
 * Static regression: contract-worker's outbox relay + scheduled purge must run
 * on the BYPASSRLS scannerDb, not the tenant-scoped contract_svc `db`. Mirrors
...
describe("contract worker outbox relay + purge use scannerDb", () => {
