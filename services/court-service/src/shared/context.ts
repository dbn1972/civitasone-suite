...
export const ERROR_CODES = {
  ...
  DEFECT_INVALID_TRANSITION: 422,
  DEFECT_VERSION_CONFLICT: 409,
  SCRUTINY_NOT_FOUND: 404,
  SCRUTINY_INVALID_TRANSITION: 422,
  SCRUTINY_VERSION_CONFLICT: 409,
  PARCEL_NOT_FOUND: 404,
  PARCEL_VERSION_CONFLICT: 409,
  PARTY_NOT_FOUND: 404,
  PARTY_VERSION_CONFLICT: 409,
