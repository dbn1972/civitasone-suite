...
import { onboardingHealthRoutes } from "./modules/onboarding-health/routes.js";
...
export async function buildApp(): Promise<FastifyInstance> {
  ...
  // G19: Onboarding health metric framework — rule-based milestone health checks
  await app.register(onboardingHealthRoutes);
