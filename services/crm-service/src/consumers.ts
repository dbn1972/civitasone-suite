...
import { registerContextAttachConsumers } from "./modules/context-attach/consumer.js";
...
export function registerAllConsumers(queue: Queue): void {
  ...
  // G22: Context-attach rule engine — inbound event auto-linking
  registerContextAttachConsumers(queue);
}
