...
import { registerOnboardingHealthConsumers } from "./modules/onboarding-health/consumer.js";
...
export function registerAllConsumers(queue: Queue): void {
  ...
  // G19: Onboarding health metric framework — rule CRUD + score recompute
  registerOnboardingHealthConsumers(queue);
}
