...
import { registerDueHorizonConsumers } from "./modules/due-horizon/consumer.js";
...
export function registerAllConsumers(queue: Queue): void {
  ...
  // G17: due-horizon work-queue generator consumers
  registerDueHorizonConsumers(queue);
}
