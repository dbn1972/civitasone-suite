/**
 * CRM search indexing — wires @civitasone/search indexing via the outbox.
 *
...
/** Index or update a CRM entity in the global search. */
...
/** Remove a CRM entity from the global search (on soft-delete). */
