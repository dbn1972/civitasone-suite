...
import { fieldActionRoutes } from "./modules/field_actions/routes.js";
import { hotspotRoutes } from "./modules/hotspots/routes.js";
...
export async function buildApp(): Promise<FastifyInstance> {
  ...
  registerOpsRoutes(app, { service: "drainage-service", checks: { db: { ping: () => dbPing(sqlClient) }, cache, queue } });
  registerSchemaErrorHandler(app, HttpError);

  await app.register(complaintRoutes);
  await app.register(fieldActionRoutes);
  await app.register(hotspotRoutes);
