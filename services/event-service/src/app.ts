...
import { nocRoutes } from "./modules/nocs/routes.js";
import { permitRoutes } from "./modules/permits/routes.js";
import { postEventRoutes } from "./modules/post_event/routes.js";
...
export async function buildApp(): Promise<FastifyInstance> {
  ...
  await app.register(nocRoutes);
  await app.register(permitRoutes);
  await app.register(postEventRoutes);
