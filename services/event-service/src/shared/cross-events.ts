 ...
 *
 * Same template as building-service's/shop-service's cross-events.ts (Wave 3
 * per-service integration) — this file is a near-drop-in for all 17
 * municipal services.
 *
 * NOT wired into this service's command/consumer call sites here except
 * where the corresponding PR says so.
 */
