/**
 * Finance search indexing — wires @civitasone/search indexing via the outbox.
 *
...
/** Index or update a finance entity in the global search. */
...
/** Remove a finance entity from the global search (on soft-delete). */
