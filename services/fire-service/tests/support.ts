/**
 * Shared test support for fire-service's DB-backed integration suite.
 * Mirrors services/animal-service/tests/support.ts (PR #1007) and
 * services/swm-service/tests/support.ts.
 *
...
export const OFFICER_ROLES = ["fire_admin", "fire_officer", "super_admin"];
export const INSPECTOR_ROLES = ["fire_admin", "fire_officer", "fire_inspector", "super_admin"];
export const USER_ROLES = ["fire_user", "super_admin"];

export function hdr(
  sub = ACTOR_A,
  tid = TENANT_A,
  roles: string[] = OFFICER_ROLES,
