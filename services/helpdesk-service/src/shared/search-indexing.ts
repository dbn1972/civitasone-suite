/**
 * Helpdesk search indexing — wires @civitasone/search indexing via the outbox.
 *
...
/** Index or update a helpdesk entity in the global search. */
...
/** Remove a helpdesk entity from the global search (on soft-delete). */
