...
import { registerPlaybookConsumers } from "./modules/playbooks/consumer.js";
...
// G13 — resolution playbooks: lifecycle commands + auto-attach on ticket creation.
registerPlaybookConsumers(queue);
await queue.start();
