/**
 * HRMS search indexing — wires @civitasone/search indexing via the outbox.
 *
...
/** Index or update an HRMS entity in the global search. */
...
/** Remove an HRMS entity from the global search (on soft-delete). */
