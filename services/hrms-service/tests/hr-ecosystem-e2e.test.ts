...
describe("5. Payroll & Salary", () => {
  // FLAKY-SKIP: See SKIP comment above — hits a payroll-service route from an hrms-service test file; already covered by payroll-service/tests/routes.test.ts. (expires: 2026-12-13)
