...
vi.mock("../src/modules/assignment/repo.js", () => ({
  ...
  findCapacityTx: (...args: unknown[]) => mockFindCapacity(...args),
  findConflicts: (...args: unknown[]) => mockFindConflicts(...args),
  findConflictsTx: (...args: unknown[]) => mockFindConflicts(...args),
  countDailyAssignments: (...args: unknown[]) => mockCountDailyAssignments(...args),
  countDailyAssignmentsTx: (...args: unknown[]) => mockCountDailyAssignments(...args),
