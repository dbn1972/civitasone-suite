...
CREATE POLICY tenant_isolation ON cases.legal_case_types
...
CREATE POLICY tenant_isolation ON cases.legal_cases
  USING (tenant_id = current_tenant_id());
...
CREATE POLICY tenant_isolation ON cases.legal_parties
  USING (tenant_id = current_tenant_id());
...
CREATE POLICY tenant_isolation ON hearings.legal_hearings
  USING (tenant_id = current_tenant_id());
...
CREATE POLICY tenant_isolation ON hearings.legal_orders
  USING (tenant_id = current_tenant_id());
...
CREATE POLICY tenant_isolation ON hearings.legal_opinions
  USING (tenant_id = current_tenant_id());
...
CREATE POLICY tenant_isolation ON notices.legal_notices
  USING (tenant_id = current_tenant_id());
...
CREATE POLICY tenant_isolation ON notices.legal_notice_responses
  USING (tenant_id = current_tenant_id());
...
CREATE POLICY tenant_isolation ON contracts.legal_contract_reviews
  USING (tenant_id = current_tenant_id());
...
CREATE POLICY tenant_isolation ON contracts.legal_clearances
  USING (tenant_id = current_tenant_id());
...
CREATE POLICY tenant_isolation ON settlements.legal_settlements
  USING (tenant_id = current_tenant_id());
...
CREATE POLICY tenant_isolation ON settlements.legal_lok_adalat
  USING (tenant_id = current_tenant_id());
...
CREATE POLICY tenant_isolation ON reminders.legal_reminders
  USING (tenant_id = current_tenant_id());
...
CREATE POLICY tenant_isolation ON opinions.legal_opinions
  USING (tenant_id = current_tenant_id());
...
CREATE POLICY tenant_isolation ON counsel.legal_counsel_briefs
  USING (tenant_id = current_tenant_id());
...
CREATE POLICY tenant_isolation ON filings.legal_filings
  USING (tenant_id = current_tenant_id());
