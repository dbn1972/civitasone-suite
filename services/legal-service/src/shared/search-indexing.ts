/**
 * Legal search indexing — wires @civitasone/search indexing via the outbox.
 *
...
/** Index or update a legal entity in the global search. */
...
/** Remove a legal entity from the global search (on soft-delete). */
