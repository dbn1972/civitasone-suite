...
import { treeRequestRoutes } from "./modules/tree_requests/routes.js";
...
export async function buildApp(): Promise<FastifyInstance> {
  ...
  registerOpsRoutes(app, { service: "parks-service", checks: { db: { ping: () => dbPing(sqlClient) }, cache, queue } });
  registerSchemaErrorHandler(app, HttpError);

  await app.register(complaintRoutes);
  await app.register(treeRequestRoutes);
