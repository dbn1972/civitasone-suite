/**
 * Project search indexing — wires @civitasone/search indexing via the outbox.
 *
...
/** Index or update a project entity in the global search. */
...
/** Remove a project entity from the global search (on soft-delete). */
