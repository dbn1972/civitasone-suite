 ...
 *
 * WHY: project domain tables have FORCED row-level security whose policy is
 ...
 * project_svc role (#146). Same fix as telephony-service (PR #152): apply it at
 * consumer-registration so the worker AND DB-backed tests get scoped handlers.
 */
