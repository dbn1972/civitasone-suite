...
import { registerRestorationConsumers } from "./modules/restoration/consumer.js";

const log = pino({ name: "roadcut-worker" });
...
log.info("roadcut-service worker: command consumers + outbox relay running");
