/**
 * Shared test support for roadcut-service's DB-backed integration suite.
...
export const USER_ROLES = ["roadcut_user", "roadcut_admin", "super_admin"];
export const ADMIN_ROLES = ["roadcut_admin", "super_admin"];
