...
import { bulkGeneratorRoutes } from "./modules/bulk_generators/routes.js";
...
export async function buildApp(): Promise<FastifyInstance> {
  ...
  registerOpsRoutes(app, { service: "swm-service", checks: { db: { ping: () => dbPing(sqlClient) }, cache, queue } });
  registerSchemaErrorHandler(app, HttpError);

  await app.register(complaintRoutes);
  await app.register(bulkGeneratorRoutes);
