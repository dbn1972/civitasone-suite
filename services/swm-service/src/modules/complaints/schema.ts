...
export const swmComplaints = swmSchema.table("swm_complaints", {
...
export type ComplaintRow = typeof swmComplaints.$inferSelect;
export type ComplaintInsert = typeof swmComplaints.$inferInsert;
export const schema = { swmComplaints };
