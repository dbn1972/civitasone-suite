/**
 * Shared test support for vendor-service's DB-backed integration suite.
 * Mirrors services/animal-service/tests/support.ts (the fleet reference for
 * this pattern) and services/swm-service/tests/support.ts.
 *
...
export function hdr(
  sub = ACTOR_A,
  tid = TENANT_A,
  roles: string[] = ["vendor_admin", "super_admin"],
