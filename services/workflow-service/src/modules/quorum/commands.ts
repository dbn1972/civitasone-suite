...
export const createCommitteeDecision = (ctx: RequestContext, body: Record<string, unknown>) =>
  pub(ctx, COMMANDS.createCommitteeDecision, randomUUID(), body);
export const castCommitteeVote = (ctx: RequestContext, id: string, body: Record<string, unknown>) =>
  pub(ctx, COMMANDS.castCommitteeVote, id, body);
