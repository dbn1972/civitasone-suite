/**
 * Static regression: works-worker's outbox relay + scheduled purge must run
 * on the BYPASSRLS scannerDb, not the tenant-scoped works_svc `db`. Mirrors
...
describe("works worker outbox relay + purge use scannerDb", () => {
